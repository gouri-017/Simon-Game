...
- The player now has to reproduce the chain of flash using his memory.
...
```
2. **Acess the Code**: Once cloned, navigate to the project directory in your terminal or command prompt.
   ```bash
   cd repository
   ```
3. **Edit in your editor**: Use your preferred code editor to make changes to the codebase.
4. **Commit and Push Changes**: After making the changes, commit the changes to your local repository and push them to the Github Repository.
   ```bash
   git add .
